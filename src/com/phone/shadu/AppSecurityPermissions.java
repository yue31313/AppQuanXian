...
public class AppSecurityPermissions  implements View.OnClickListener {
    ...
    public View getPermissionsView() {
        ...
        mDefaultGrpLabel = "default_permission_group";
        mPermFormat = "string.permissions_format";
    ...
    private void displayPermissions(boolean dangerous) {
        ...
        for (String loopPermGrpInfoStr : permInfoStrSet) {
            ...
            if(localLOGV) Log.i("#####eeee", "Adding view group:" + grpLabel + ", desc:"
    ...
    private void displayNoPermissions() {
     ...
     private View getPermissionItemView(CharSequence grpName, String permList,
        ...
        if (dangerous) {
            ...
            permGrpView.setTextColor(Color.GREEN);//R.color.perms_dangerous_grp_color
            permDescView.setTextColor(Color.RED);//R.color.perms_dangerous_perm_color
        }
